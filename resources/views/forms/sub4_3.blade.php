...
<form class="multisteps-form__form" action="{{ route('sub4_3') }}" id="wizard" method="POST" enctype="multipart/form-data">
	@csrf
					...
					<div class="form-content pera-content">
						<div class="step-inner-content">
							...
							<div class="form-inner-area">
								<div class="row">
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="nysc_callup_number" class="form-control required" placeholder="NYSC callup registration number" required value="{{ $customer->other_details != null ? json_decode($customer->other_details)->nysc_callup_number : '' }}">
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="number" name="nysc_netpay" class="form-control required" placeholder="NYSC Netpay" required value="{{ $customer->other_details != null ? json_decode($customer->other_details)->nysc_netpay : '' }}">
									</div>
									<div class="col-md-12 col-lg-12 col-sm-12">
										<input type="text" name="employer_netpay" class="form-control required" placeholder="Employer Netpay" required value="{{ $customer->other_details != null ? json_decode($customer->other_details)->employer_netpay : '' }}">
									</div>
								</div>
							</div>
							<div class="step-content-area" style="margin-top: -60px;">
							...
							<div class="step-content-area" style="margin-top: -60px;">
								<div class="budget-area">
									...
									<select required name="current_employer_state">
										...
										<option {{ ($customer->state == $state->state->name)?'selected':'' }}>{{ $state->state->name }}</option>
										@endforeach
									</select>
							...
							<div class="form-inner-area">
								<div class="row">
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="current_employer_number" class="form-control required" placeholder="Employer's Number" required value="{{ $customer->employer_number }}">
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
									...
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="current_employer_staff_id" class="form-control required" placeholder="Staff ID Number" required value="{{ $customer->staff }}">
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="current_employer_pension_number" class="form-control required" placeholder="Pension Number" required value="{{ $customer->pension_number }}">
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="current_employer_tax_id_number" class="form-control required" placeholder="Tax Identification Number" required value="{{ $customer->tid }}">
									</div>
									<div class="col-md-6 col-lg-6 col-sm-12">
										<input type="text" name="current_employer_position" class="form-control required" placeholder="Position / Job Title at Workplace" required value="{{ $customer2->position }}">
									</div>
									<div class="col-md-12 col-lg-12 col-sm-12">
										<label>Date Employed</label>
										<input type="date" name="date_employed" class="form-control required" placeholder="Date Employed" required value="{{ $customer2->date_employed }}">
										</div>
									</div>
									<div class="col-md-12 col-lg-12 col-sm-12">
...
<script>
	$(function() {
		...
		$("#dprev").click(function(){
			$(".mmi").hide();
			$(".ddi").show();
			var url = "{{ url('/getback') }}?place=three";
			$.ajax({    
                type: "GET",
                url: url,             
                success: function(d) {  
		...
		var durl = encodeURI('{{ url("/getLgas2") }}/'+dstate);
		$.ajax({    
	        type: "GET",
	        url: durl,             
	        success: function(d) {  
		...
		$('select[name="current_employer_state"]').on('change', function(){
			...
			var url = encodeURI('{{ url("/getLgas2") }}/'+state);
			$.ajax({    
                type: "GET",
                url: url,             
                success: function(d) {  
