    ...
    <div class="card auth-card shadow-lg">
        <div class="card-body">
            <div class="px-3">
                ...
                <img src="{{ asset('assets/images/404.png') }}" alt="" class="d-block mx-auto mt-4" height="250">
                <div class="text-center auth-logo-text mb-4">
                    <h4 class="mt-0 mb-3 mt-5">The Page you are trying to access does not exists!</h4>
                    @auth
