...
@section('title', __('Processed Files || Swiss Credit Data Management system'))

@section('data', __('active'))
@section('customersP', __('active'))
        ...
        <div class="page-title-box">
            <div class="float-right">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Processed Files </li>
                </ol>
            </div>
            <h4 class="page-title">Processed Files</h4>
        </div>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">All Processed Loan Applications</h4>
