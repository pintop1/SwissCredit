        ...
        <div>
            ...
            <table class="summ">
                <tr>
                    ...
                    <th>{{ strtoupper($offer->name) }}</th>
                </tr>
                <tr>
                    <td>BVN</td>
                    <td>{{ strtoupper($offer->bvn) }}</td>
                </tr>
                <tr>
                    <td>RESIDENTIAL ADDRESS</td>
                    <td>{{ strtoupper($offer->address) }}</td>
                </tr>
                <tr>
                    <td>PHONE NUMBER</td>
                    <td>{{ strtoupper($offer->phone_number) }}</td>
                </tr>
                <tr>
                    <td>CUSTOMERS MAIL</td>
                    <td>{{ strtoupper($offer->customers_email) }}</td>
                </tr>
                <tr>
                    <td>EMPLOYER</td>
                ...
                <tr>
                    <td rowspan="19">LOAN DETAILS</td>
                    <td>LOAN PURPOSE</td>
                    <td>{{ strtoupper($offer->purpose) }}</td>
                </tr>
                <tr>
                    <td>AMOUNT REQUESTED</td>
                    <td>N{{ number_format($offer->amount_requested) }}</td>
                </tr>
                <tr>
