...
@section('title', __('Referrals || Swiss Credit Data Management system'))
                ...
                <table id="row_callback" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $post->phone }}</td>
                            <td>{{ $post->code }}</td>
                            <td>{!! "<div class='d-inline-block p-2'><a target='_blank' class='btn btn-primary btn-small text-white' href=".url('/referrals/view/'.$post->code)."><i class='dripicons dripicons-forward'></i> View Referrals</a></div>" !!}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
