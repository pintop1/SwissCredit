...
@section('title', __('Loan Renewals || Swiss Credit Data Management system'))

@section('data', __('active'))
@section('renewals', __('active'))
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Renewals</h4>
        </div>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">All Renewals</h4>
                ...
                <table id="row_callback" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        @php
                        $second = Utils::getCustomer2nd($post->id);
                        @endphp
                        <tr>
                            <td>{{ $i++ }}</td>
                            ...
                            <td>{{ number_format($second->loan_amount_requested,2) }}</td>
