...
@section('title', __('Loan Top-up || Swiss Credit Data Management system'))

@section('data', __('active'))
@section('topups', __('active'))
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Top Ups</h4>
        </div>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">All Top-Ups</h4>
