...
@section('title', __('NYSC forms || Swiss Credit Data Management system'))

@section('data', __('active'))
@section('nysc', __('active'))
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">New Loans</h4>
        </div>
    </div>
</div>
@endsection
                ...
                <table id="row_callback" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($post->other_details)->nysc_callup_number }}</td>
